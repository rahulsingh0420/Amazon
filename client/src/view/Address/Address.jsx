...
export default function Address(){
    ...
    const remove = (_id)=>{
        axios.post("http://localhost:4000/deleteAddress", {_id:_id}, {
            headers:{
    ...
    const setDefault=(_id)=>{
        axios.post("http://localhost:4000/setDefaultAddress",{_id:_id, userId:user?._id},{
            headers:{
                "Content-Type" : "application/x-www-form-urlencoded"
            }
        } )
    ...
    const getAddress = ()=>{
        axios.post("http://localhost:4000/getAddress",{userId: user._id}, {
            headers:{
                "Content-Type" : "application/x-www-form-urlencoded"
            }
        })
    ...
    return(
            ...
            <div className="container"><div className="fs-2 p-3">
                Your Addresses
            </div></div>
            ...
            <div className="container">
                <div className="row">
                    {
                        addresses.length < 2 &&
                        <div className="col-sm-6 py-2 px-4">
                        <Link to={'/addAddress'} className="text-decoration-none d-flex justify-content-center align-items-center add-address-card card">
                            <div className="d-flex flex-column">
                            <i classN="p-4 fa-solid fa-plus fa-2xl" style={{ color:"#dddddd", fontSize:"4em" }}></i>
                            <div className="py-4"><span>
                                Add Address
                            </span></div>
                            </div>
                        </Link>
