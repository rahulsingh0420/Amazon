    ...
    return (
        <>
            <div style={{ backgroundColor: "#131921"}} className="py-1 container-fluid">
                <div className="row">
                    <div className="col-sm-12 d-flex flex-row align-items-center justify-content-between" style={{ position: "relative" }}>
                        <div className="d-flex flex-row">

                            <div>
                                <button className="btn hoverWhiteBorder" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                                    <i className="fa-solid fa-list-ul fa-lg" style={{ color: "#ffffff" }}></i>
                                </button>
                                <div className="offcanvas offcanvas-start" style={{ backgroundColor:"#131921" }} tabIndex={-1} id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                                    <div className="offcanvas-header">
                                        <h5 className="offcanvas-title" id="offcanvasExampleLabel"><div className="h2 fw-bold text-white">Amazon Admin Page</div></h5>
                                        <button type="button" style={{ backgroundColor:"#ff9900" }} className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close" />
                                    </div>
                                    <div className="offcanvas-body ps-0 mt-3">
                                      <ul className="m-0 p-0">
                                            <li><NavLink className="d-block navlink w-100 p-3 fs-5 fw-bold text-decoration-none text-end pe-5" style={{ borderTopLeftRadius:"none", borderBottomLeftRadius:"none" }} to='/admin'>Admin Panel</NavLink></li>  
                                            <li><NavLink className="d-block navlink text-decoration-none w-100 p-3 fs-5 fw-bold text-end pe-5" style={{ borderTopLeftRadius:"none", borderBottomLeftRadius:"none" }} to='/users'>Users</NavLink></li>  
                                            <li><NavLink className="d-block navlink text-decoration-none w-100 p-3 fs-5 fw-bold text-end pe-5" style={{ borderTopLeftRadius:"none", borderBottomLeftRadius:"none" }} to='/categories'>Categories</NavLink></li>
                                            <li><NavLink className="d-block navlink text-decoration-none w-100 p-3 fs-5 fw-bold text-end pe-5" style={{ borderTopLeftRadius:"none", borderBottomLeftRadius:"none" }} to='/allorders'>Orders</NavLink></li> 
                                      </ul>  
                                    </div>
                                </div>
                            </div>
