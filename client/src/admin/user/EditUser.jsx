...
useEffect(()=>{
    axios.get(`http://localhost:4000/getUser/${_id}`)
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        axios.post(`http://localhost:4000/editUser/${_id}`, user, {
            headers: {
                        ...
                        <div className="card px-3">
                            ...
                            <form onSubmit={submitHandler}>
                                <div className="p-2">
                                    ...
                                    <input type="text" style={{ fontSize: "13px" }} placeholder="First and last name" autoFocus name="name" className="p-1 form-control rounded border outline-none ps-2" onChange={inputHandler} value={user.name} />
                                    {errors.map(err => {
                                        return (
                                ...
                                <div className="p-2 d-flex flex-row justify-content-between align-items-center">
                                    ...
                                    <div className="w-75 d-flex flex-row align-items-center">
                                        ...
                                        <div className="d-flex flex-column w-100">
                                            <input style={{ fontSize: "13px" }} placeholder="Mobile number" type="number" name="mobileNo" className="p-1 w-100 rounded form-control border outline-none ps-2" onChange={inputHandler} value={user.mobileNo} />
                                            {errors.map(err => {
                                                return (
                                ...
                                <div className="p-2">
                                    ...
                                    <input style={{ fontSize: "13px" }} placeholder="Email Address" type="email" name="email" className="p-1 form-control rounded border outline-none ps-2" onChange={inputHandler} value={user.email} />
                                    {errors.map(err => {
                                        return (
                                ...
                                <div className="p-2" style={{ lineHeight: "1" }}>
                                    ...
                                    <input style={{ fontSize: "13px" }} type="password" placeholder="At least 6 charecters" name="password" className="p-1 ps-2 form-control rounded border outline-none mb-0" onChange={inputHandler} value={user.password} />
                                    {errors.map(err => {
                                        return (
                                ...
                                <Link to={'/users'} className="me-1 btn w-50 btn-sm btn-secondary" style={{ borderRadius: "10px" }}>Cancel</Link>
                                    <button type="submit" className="btn w-100 btn-sm btn-warning" style={{ borderRadius: "10px" }}>Update</button>
                                </div>
                            </form>
                            {/* form ends here  */}
